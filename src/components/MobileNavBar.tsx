...
import { Home, Search, Heart, Menu, X, ShoppingCart, User, Phone, ChevronRight, Flower2 } from 'lucide-react';
...
export default function MobileNavBar({ showBottomBar = true }: MobileNavBarProps) {
  ...
  // Close overlays event (used by Header and other components)
  useEffect(() => {
    ...
    return () => window.removeEventListener('closeAllOverlays', handleCloseAll);
  }, []);
        ...
        >
          ...
          >
            <motion.div
              ...
              style={{
                background:
                  'linear-gradient(90deg, transparent, #ec4899, #f472b6, #ec4899, transparent)',
            ...
            <div className="flex items-center justify-around py-2 px-2">
                ...
                if (item.action === 'search') {
                  return (
                    <button
                      ...
                      className="flex flex-col items-center gap-1 py-2 px-4 rounded-xl transition-all duration-300 active:scale-95 group"
                    >
                      <div className="p-2 rounded-xl transition-all duration-300 group-hover:bg-primary-50 group-active:bg-primary-100">
                        <item.icon
                          size={22}
              ...
              >
                <div
                  className="p-2 rounded-xl transition-all duration-300 group-hover:bg-primary-50 group-active:bg-primary-100"
                  style={{ backgroundColor: 'rgba(224, 90, 76, 0.1)' }}
                >
                  <Menu size={22} style={{ color: '#e05a4c' }} />
                </div>

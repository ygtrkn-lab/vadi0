...
export const SPECIAL_DAYS: SpecialDay[] = [
  {
    ...
    description: "14 Şubat Sevgililer Günü'nde aşkınızı en güzel çiçeklerle ifade edin. Kırmızı güller, romantik buketler ve özel aranjmanlarla sevgilinizi mutlu edin. Vadiler Çiçek ile hızlı ve güvenli teslimat.",
    metaTitle: "Sevgililer Günü Çiçekleri 2025 | 14 Şubat Özel | Vadiler Çiçek",
    metaDescription: "Sevgililer Günü için en romantik çiçekler! Kırmızı güller, kalp buketler, özel aranjmanlar. İstanbul'a hızlı ve güvenli teslimat. Vadiler Çiçek",

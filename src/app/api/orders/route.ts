...
export async function POST(request: NextRequest) {
  try {
    ...
    const orderData = {
      ...
      traffic_source: newOrder.traffic_source || null,
      traffic_medium: newOrder.traffic_medium || null,
      traffic_campaign: newOrder.traffic_campaign || null,
      traffic_referrer: newOrder.traffic_referrer || null,
      timeline,
